...
wait until clk'event and clk = '1' and 
		valor(15 downto 8 ) = horas and  
		valor(7 downto 0 ) = minutos and 
		periodo = AM_PM;
  ...
  begin
	...
	tecleo(ena_cmd, cmd_tecla, clk, X"A");--Pulsacion corta de la tecla A
  ...
  begin
     while horas /= valor(15 downto 8) or AM_PM /= periodo loop
	tecleo(pulso_largo, cmd_tecla, clk, X"C");
       end loop;
	
       tecleo(ena_cmd, cmd_tecla, clk, X"B"); --Ãpara cambiar el campo
