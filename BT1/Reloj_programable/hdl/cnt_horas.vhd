...
begin
  ...
  begin
    if nRst = '0' then
      ...
      if modo = '1' and ( (horas > X"11" and not(horas = X"23" and (ena = '1' or inc_campo = '1'))) or (horas = X"11" and (ena = '1' or inc_campo = '1')) ) then --Posibles errores
        AM_PM <= '1';
  ...
  ena_decenas_horas <= ena or inc_campo when horas(3 downto 0) = 9        else
                       ena or inc_campo when horas = X"23"                else --Error claro habia un mayor no un igual 
  ...
  begin
    if nRst = '0' then
      ...
      if cambiar_modo = '1' then
        ...
        if (modo = '0' and horas(7 downto 4) = X"1") or (horas(7 downto 4) = X"2" and modo = '1') then
