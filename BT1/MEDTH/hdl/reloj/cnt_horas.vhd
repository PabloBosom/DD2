...
begin
  ...
  ena_decenas_horas <= ena or inc_campo when horas(3 downto 0) = 9        else
                       ena or inc_campo when horas = X"23"                else		-- cambiamos (horas > X"23") por (horas = X"23")
                       ena or inc_campo when horas = X"11" and modo = '0' else		-- cambiamos (horas > X"11") por (horas = X"11")
                       '0';
