...
set_false_path -from [get_ports {SDA columna[0] columna[1] columna[2] columna[3]}] 
set_false_path -to [get_ports {fila[0] fila[1] SDA SCL fila[2] fila[3] mux_disp[0] mux_disp[1] mux_disp[2] mux_disp[3] mux_disp[4] mux_disp[5] mux_disp[6] mux_disp[7] seg[0] seg[1] seg[2] seg[3] seg[4] seg[5] seg[6] seg[7]}]
