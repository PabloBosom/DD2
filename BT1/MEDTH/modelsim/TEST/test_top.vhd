...
report "cFin de reset asincrono";
    wait for 500 us;
    wait until clk'event and clk = '1';
report "PROGRAMACION DE HORA A LAS 08:09 PM";
    ...
    wait for 500 us;
    wait until clk'event and clk = '1';
report "PROGRAMACION DE HORA AL MODO 24 H";
    cambiar_modo_12_24(columna, fila, clk);
	
    wait for 500 us;
    wait until clk'event and clk = '1';
report "PROGRAMACION DE HORA A LAS 05:20 AM";
    ...
    wait for 500 us;
    wait until clk'event and clk = '1';
report "PROGRAMACION DE HORA A LAS 11:59 PM";
    ...
    report "Los displays muestran la temperatura (modo 1)";
    pulsa_tecla(columna, clk, fila, X"E", pulsacion_corta);
    wait for 200 us;
    wait until clk'event and clk = '1';
    -- Los displays muestran la humedad relativa (modo 2)
     report "Los displays muestran la humedad relativa  (modo 2)";
    pulsa_tecla(columna, clk, fila, X"E", pulsacion_corta);
    wait for 200 us;
    wait until clk'event and clk = '1';
    -- Los displays muestran todo (modo 3)
    report "Los displays muestran todo  (modo 3)";
    pulsa_tecla(columna, clk, fila, X"E", pulsacion_corta);
    wait for 6 ms;
    wait until clk'event and clk = '1';
     report "Vuelve al modo por defecto (solo reloj)";
