...
begin
  ...
  begin
    if nRst = '0' then
      ...
      if reset_SDA = '1' then                 -- Se pone a '0' el bit 8 (SDA) (start, preparar stop tras ACK, o  ACK de lectura)
        ...
        reg_SDA <= (reg_SDA(7 downto 0) & '1'); -- se introduce '1' para mantener el comportamiento en colector abierto
  ...
  -- Salida 
  SDA_out <= reg_SDA(8) when reg_SDA(8) = '0' else   -- salida SDA en colector abierto 
             'Z'; 
